...
(function() {
	function CitydbKmlLayer(options){	
		...
		this._maxSizeOfCachedTiles = Cesium.defaultValue(options.maxSizeOfCachedTiles, 30);	
		this._maxCountOfVisibleTiles = Cesium.defaultValue(options.maxCountOfVisibleTiles, 50);		
...
//{
//"DEHH_9d4c8b35-56b8-4fae-9228-46a2686391d8": Cesium.Color.RED,
//"DEHH_abbc7258-2387-49b7-bd82-ad89df59a447": Cesium.Color.YELLOW
//}
//); 
//
//    
...
//    CitydbKmlLayer.prototype.highlight = function(){
//         console.log("inside tohighlight function in kmllayershahab");
//			this._highlightedObjects["96eb425b-57c7-4a2a-9d26-5a421301e848"] = toHighlight["96eb425b-57c7-4a2a-9d26-5a421301e848"];
//        
//			this.highlightObject(this.getObjectById("96eb425b-57c7-4a2a-9d26-5a421301e848"));
//			
//		this._highlightedObjects = this._highlightedObjects;
//	}
...
//	CitydbKmlLayer.prototype.highlight = function(toHighlight){
//         console.log("shahab",toHighlight);
//		console.log("hl",this._highlightedObjects);
//			this._highlightedObjects["96eb425b-57c7-4a2a-9d26-5a421301e848"] = toHighlight["96eb425b-57c7-4a2a-9d26-5a421301e848"];
//        
//			this.highlightObject(this.getObjectById("96eb425b-57c7-4a2a-9d26-5a421301e848"));
//			
...
//    shahab
	var tempColor = new Cesium.Color(0.0, 1.0, 0.0, 1);
    
    
    CitydbKmlLayer.prototype.setEntityColorByPrimitive = function(entity, tempColor){
		var primitives = this._cesiumViewer.scene.primitives;
		for (var i = 0; i < primitives.length; i++) {
			var primitive = primitives.get(i);
			if (primitive instanceof Cesium.Primitive && Cesium.defined(primitive._instanceIds)) {					
